document.addEventListener('DOMContentLoaded', function() {
    ...
    btn1.querySelector('button').addEventListener('click', function(event) {
        event.stopPropagation();
        floatingBox1.style.display = 'none';
        isFloatingBox1Visible = false;
    });

    btn2.querySelector('button').addEventListener('click', function(event) {
        event.stopPropagation();
        floatingBox2.style.display = 'none';
        isFloatingBox2Visible = false;
    });
	
	btn3.querySelector('button').addEventListener('click', function(event) {
        event.stopPropagation();
        floatingBox3.style.display = 'none';
        isFloatingBox3Visible = false;
    });
    ...
    closeBtn.addEventListener('click', function(event) {
        event.stopPropagation();
        if (isFloatingBox1Visible || isFloatingBox2Visible || isFloatingBox3Visible) {
            floatingBox1.style.display = 'none';
            floatingBox2.style.display = 'none';
            floatingBox3.style.display = 'none';
            isFloatingBox1Visible = false;
